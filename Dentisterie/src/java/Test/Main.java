...
//                  Dent.insertEtatDentPatient(co, 11, i, Integer.valueOf(etatTest));
...
//                  Dent.insertEtatDentPatient(co, 7, Integer.valueOf(nify[i]), Integer.valueOf(etatpartiel[i]));
//              }
//          }
            Dent.insertSpecialAlea(co, 12, test, etatTest);
          
          
    }
    
//    public String[] avoirDonner(String donner){
//        
//    }
}
