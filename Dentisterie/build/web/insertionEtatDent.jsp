<%@page import="model.scan.ResultatScan"%>
<%@page import="model.Dent.Dent"%>
<% Dent[] allDent = (Dent[]) request.getAttribute("allDent");
 ResultatScan[] allEtat= (ResultatScan[]) request.getAttribute("allEtat");
...
<div class="container">
        <div class="card p-5">
            <div class="card-body">
                <h5 class="card-title">INSERTION ETAT DE DENT PATIENT</h5>
                <form method="GET" action="InsertEtatDent">
                    <div class="row ">
                        <table class="table table-hover">
                           ...
                           <tbody>
                               <% for (int i = 0; i < allDent.length; i++) { %>
                                ...
                                <tr>
                                    <td><%= allDent[i].getIdDent() %></td>
                                    <td><%= allDent[i].getNom()%></td>
                                    <td>
                                         <select class="form-select" id="article" name="etat[]" style="width: 10rem">
                                             <% for (int j = 0; j < allEtat.length; j++) { %>
                                                <option value="<%= allEtat[j].getEtat()%>"><%= allEtat[j].getDesignationEta() %></option>
                                             <% } %>
                                         </select>
                                    </td>
                                </tr>
