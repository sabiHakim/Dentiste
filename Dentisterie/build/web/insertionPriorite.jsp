...
<div class="container">
        <div class="card p-5">
            <div class="card-body">
                 <h5 class="card-title">CHOIX DE PRIORITE POUR LE TRAITEMENT DES DENTS</h5>
                 <form method="GET" action="resultatTraitement.jsp">
                    
                    <div class="row ">
                        <div class="input-group mb-3  col-lg-12">
                            <label class="input-group-text" for="priorite">Priorite</label>
                            <select class="form-select" id="article" name="etat" style="width: 10rem">
                                <option value="0">Sante</option>
                                <option value="1">Beaute</option>
                            </select>
                       </div>
                    </div>
                    <div class="col-12 ">
                        <button type="submit" class="btn btn-primary col-12 mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal">Valider</button>
                    </div>
                </form>
            </div>
        </div>
