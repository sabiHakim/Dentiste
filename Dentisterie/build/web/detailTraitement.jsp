...
<% DetailSoin[] detail = (DetailSoin[]) request.getAttribute("detail"); %>
...
<div class="container">
        <div class="card p-5">
            <div class="card-body">
                <h5 class="card-title">DETAIL DE TRAITEMENT DU DENT</h5>
                        ...
                        <table class="table table-hover">
                           ...
                           <tbody>
                               <% for (int i = 0; i < detail.length; i++) { %>
                                    ...
                                    <tr>
                                        <td><%= detail[i].getEtat().getDesignationTypeSoin()%></td>
                                        <td><%= detail[i].getEtatInitial() %></td>
                                        <td><%= detail[i].getEtatFinal()%></td>
                                        <td><%= detail[i].getCout()%> MGA</td>
                                    </tr>
...
<!--                               <tr>
                    ...
                    <div class="row">
                        <div class="input-group mb-3">
                            <div class="col-lg-2"><a href="Proposition"><button type="button" class="btn btn-outline-primary " id="plus">RETOUR</button></a></div>
                        </div>
                    </div>
                </form>
            </div>
